...
let favoriteBook = Book(title: "To Kill a Mockingbird", author: "Harper Lee", pages: 281, price: 5.99)
...
let myLaptop = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 4576)
