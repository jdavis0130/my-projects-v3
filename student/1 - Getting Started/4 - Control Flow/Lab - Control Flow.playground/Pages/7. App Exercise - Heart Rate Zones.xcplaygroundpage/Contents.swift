...
switch currentHR {
    ...
    case 161...180:
        print("You are in the hard zone. Activity in this zone increases maximum preformance capacity for ahorter sessions.")
    case 181...200:
        print("You are in the maximum zone. Activity in this zone helps fit athletes develop speed.")
        if currentHR > 200 {
           print("Woah, there! Slow down. You are in the danger zone. Your hear rate is exceeding the safe zone.")
        }
    default:
        print("Invalid")
}
