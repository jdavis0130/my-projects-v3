...
struct User {
    ...
    static var currentUser = User(userName: "Levi", email: "Davis.levi@hotmail.com", age: 26)
 ...
 */
User.logIn(user: User(userName: "Another Person", email: "different email", age: 38))
