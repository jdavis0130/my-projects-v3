...
let Levi = User(name: "Levi", age: 26, height: 6.25, weight: 100, activityLevel: 2)
print("My name is \(Levi.name). I am \(Levi.age) years old, with a height of \(Levi.height) cm and a weight of \(Levi.weight) lbs. I have an activity level of \(Levi.activityLevel).")
